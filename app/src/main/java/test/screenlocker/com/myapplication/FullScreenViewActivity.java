...
import test.screenlocker.com.myapplication.model.Wallpaper;
import test.screenlocker.com.myapplication.utils.Utils;
...
public class FullScreenViewActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // llDownloadWallpaper.setOnClickListener();
    ...
    private void fetchFullResolutionImage() {
        ...
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.GET, url,
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    ImageLoader imageLoader = LocKAppApplicaton
        ...
        LocKAppApplicaton.getInstance().getRequestQueue().getCache().remove(url);
