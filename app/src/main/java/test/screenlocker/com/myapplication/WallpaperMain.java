...
import test.screenlocker.com.myapplication.adapter.NavDrawerListAdapter;
import test.screenlocker.com.myapplication.model.Category;

import static test.screenlocker.com.myapplication.R.drawable;
import static test.screenlocker.com.myapplication.R.id;
import static test.screenlocker.com.myapplication.R.layout;
import static test.screenlocker.com.myapplication.R.string;

/**
 * Created by samreen on 12/8/2016.
 */
...
public class WallpaperMain extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDrawerList = (ListView) findViewById(id.list_slidermenu);

        navDrawerItems = new ArrayList<NavDrawerItem>();

        // Getting the albums from shared preferences
        albumsList =LocKAppApplicaton.getInstance().getPrefManger().getCategories();

        // Insert "Recently Added" in navigation drawer first position
        Category recentAlbum = new Category(null,
                getString(string.nav_drawer_recently_added));
        ...
        mDrawerToggle = new ActionBarDrawerToggle(this, mDrawerLayout,drawable.ic_drawer,
                string.app_name) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
           ...
           //     Intent intent = new Intent(WallpaperMain.this,
